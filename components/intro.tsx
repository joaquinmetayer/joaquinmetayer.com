  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-bold">+1 year</span> of experience and <span className="font-bold">+5 years</span> in the software industry. I enjoy
      ...
      >
        ...
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.05] hover:scale-[1.05] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://github.com/joaquinmetayer"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
