...
var anime = (function () {
  var t = {
      ...
      easeInOutBack: function (t, n, e, r, a) {
        var a = 1.70158;
        return (t /= r / 2) < 1
          ? (e / 2) * (t * t * (((a *= 1.525) + 1) * t - a)) + n
          : (e / 2) * ((t -= 2) * t * (((a *= 1.525) + 1) * t + a) + 2) + n;
      },
      ...
      easeInOutBounce: function (n, e, r, a) {
        return a / 2 > n
          ? 0.5 * t.easeInBounce(2 * n, 0, r, a) + e
          : 0.5 * t.easeOutBounce(2 * n - a, 0, r, a) + 0.5 * r + e;
      },
    },
    n = {
      duration: 1e3,
    ...
    g = function (t) {
      ...
      return (
        ...
        (e = o(c, s, a)),
        (r = o(c, s, a - 1 / 3)),
        "rgb(" + 255 * n + "," + 255 * e + "," + 255 * r + ")"
      );
    },
    h = function (t) {
      return r.rgb(t) || r.rgba(t)
        ? t
        : r.hex(t)
        ? d(t)
        : r.hsl(t)
    ...
    M = function (t, n) {
      return (r.html(t) || r.svg(t)) && f(e, n)
        ? "transform"
        : (r.html(t) || r.svg(t)) && y(t, n)
        ? "css"
        : (r.html(t) || r.svg(t)) && t.getAttribute(n) && !t[n]
        ? "attribute"
        : r["null"](t[n]) || r.undef(t[n])
        ? void 0
        : "object";
    },
    y = function (t, n) {
    ...
    I = function (t, n) {
      var e = n.indexOf("scale") > -1 ? 1 : 0,
        r = t.style.transform;
      if (!r) return e;
      for (var a = /(\w+)\((.+?)\)/g, u = [], i = [], o = []; (u = a.exec(r)); )
        i.push(u[1]), o.push(u[2]);
    ...
    P = function (t, e) {
      ...
      for (var u in t)
        if (!n.hasOwnProperty(u) && "targets" !== u) {
          var i = r.object(t[u]) ? m(t[u]) : { value: t[u] };
          ...
          n.forEach(function (n) {
            ...
            if (o) {
              ...
              (c.animatables = a),
                ...
                (c.delay =
                  (r.func(c.delay) ? c.delay(u, t.length) : c.delay) / c.speed),
                (c.duration =
                  (r.func(c.duration) ? c.duration(u, t.length) : c.duration) /
                  c.speed),
                (c.from = D(n.name, s, c.type, i).from),
                (c.to = D(n.name, s, c.type, i).to),
                e.push(c);
            }
          });
        }),
    ...
    S = function (t, n) {
      var e = void 0;
      if (
        ((t.currentTime = Math.min(n, t.totalDuration)),
        (t.progress = (t.currentTime / t.totalDuration) * 100),
        t.interpolations.forEach(function (r) {
          var a = C(r, n);
          (t.values[r.name] = {}),
            r.animatables.forEach(function (n) {
              var u = n.id;
        ...
        for (var r in e)
          t.animatables[r].target.style.transform = e[r].join(" ");
      t.settings.update && t.settings.update(t);
    },
    $ = function (t) {
      var n = {};
      return (
        (n.targets = s(r.array(t.targets) ? t.targets.map(c) : c(t.targets))),
        (n.animatables = k(n.targets)),
        (n.settings = E(t)),
        (n.properties = P(t, n.settings)),
        (n.interpolations = q(n.animatables, n.properties)),
        (n.totalDuration = Math.max.apply(
          Math,
          n.interpolations.map(function (t) {
        ...
        return (
          (e.tick = function () {
            n.running &&
              ((n.ended = !1),
              (e.now = +new Date()),
              (e.current = e.last + e.now - e.start),
              S(n, e.current),
              e.current >= n.totalDuration
                ? (n.settings.loop
                    ? ((e.start = +new Date()),
                      r.number(n.settings.loop) && n.settings.loop--,
                      "alternate" === n.settings.direction &&
                        n.interpolations.forEach(B),
                      (e.raf = requestAnimationFrame(e.tick)))
                    : ((n.ended = !0),
                      n.settings.complete ? n.settings.complete(n) : n.pause()),
                  (e.last = 0))
                : (e.raf = requestAnimationFrame(e.tick)));
          }),
          (n.set = function (t) {
          ...
          (n.play = function (t) {
            t && n.set(t),
              ...
              "reverse" === n.settings.direction && n.interpolations.forEach(B),
              n.settings.begin && n.settings.begin(n),
              (e.raf = requestAnimationFrame(e.tick));
          }),
          (n.pause = function (t) {
